...
for(i in 1:nclusts){
	...
	tables[[i]] <- DT::datatable(glist[[i]][1:10,], caption=htmltools::tags$caption(paste0("Top 10 gene markers for cluster #",(i-1)) ,style="color:red; font-size: 12px" ),rownames=F)
