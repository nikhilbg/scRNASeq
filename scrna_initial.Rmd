...
plot(density(sce$total_counts),col="red", xlab="Library sizes", main="")
hist(sce$total_features, xlab="Number of expressed genes", main="", 
    breaks=20, col="grey80", ylab="Number of cells")
plot(density(sce$total_features),col="red", xlab="Library sizes", main="")
hist(sce$pct_counts_feature_controls_Mt, xlab="Mitochondrial proportion (%)", 
    ylab="Number of cells", breaks=20, main="", col="grey80")
plot(density(sce$pct_counts_feature_controls_Mt),col="red", xlab="Library sizes", main="")
```
